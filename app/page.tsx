...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      >
        <defs>
          <linearGradient id="bg">
            <stop offset="0%" stopColor="rgba(255, 251, 212, 0.06)" />
            <stop offset="70%" stopColor="rgba(130, 130, 130, 0.6)" />
            <stop offset="100%" stopColor="rgba(221, 221, 221, 0.2)" />
          </linearGradient>
      ...
      {/* HERO CONTENT */}
      <div className="relative mx-auto h-4/5 flex justify-center items-center w-full px-4 py-16">
  ...
  <img
    src="/images/lpka.jpg"
    alt="Logo LPKA"
    className="w-26 md:w-30 lg:w-34 h-auto"
  />
</div>
            ...
            <p className="text-sm inline-block text-gray-400 md:text-lg">
              Selamat datang di website Lembaga Pembinaan Khusus Anak Kelas 1 Tangerang, kami berkomitmen untuk menjaga keamanan dan membangun
            ...
            >
              <svg
                className="mx-auto mt-12 md:mt-32 text-slate-50 w-12 h-12 group-hover:animate-bounce"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={1.5}
              ...
              <span className="group-hover:opacity-100 opacity-0 transition-opacity duration-1000 text-slate-50 text-xs block text-center">
                Click Me!
              </span>
            </div>
          </div>
